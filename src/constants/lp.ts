...
export const LP_AUTH = [
  ...
  },
  {
    key: 2,
    content:
      'EmailやGoogleアカウントでログイン。セキュリティと利便性を両立させた認証で、クリエイティブな学びの旅路をスムーズにスタート。ログイン後はセッション情報を取得し、自動的にユーザーページへ遷移します。',
    className: '',
  },
];
...
export const LP_START_STEP = [
  {
    ...
    src: '/login.gif',
    title: 'アプリにログイン',
    content: `メールまたはGoogleアカウントで簡単に登録可能。数秒でアプリの利用を開始できます。<br/>ログイン後はセッション情報を取得し、自動的にユーザーページへ遷移します。`,
  },
  {
    key: 2,
